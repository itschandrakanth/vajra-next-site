  ...
  return (
    <ThemeProvider theme={theme}>
      <Layout>
        ...
        <section class="text-gray-600 body-font mb-48">
          <div class="container px-5 pt-48 mx-auto mb-10">
            <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
              <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">
                Vajra Business Solutions - Try For Free
              </h1>
            ...
            <div class="flex flex-wrap -m-4">
              <div class="xl:w-1/2 md:w-1/2 p-4 cursor-pointer hover:scale-110">
                <div class="bg-indigo-50 rounded-xl">
                  <Link href="https://app.vajra.ai/accounts/signup/?=/">
                    <div class="p-6">
                      ...
                      <button class="flex text-black bg-gray-50 border-0 my-5 py-2 px-4 focus:outline-none hover:bg-blue-100 rounded-full text-sm">Try for Free →</button>
                    </div>
                  </Link>
              ...
              <div class="xl:w-1/2 md:w-1/2 p-4 cursor-pointer hover:scale-110">
                <div class="bg-green-50 rounded-xl">
                  <Link href="https://connect.vajra.ai/register">
                    <div class="p-6">
                      ...
                      <button class="flex text-black bg-gray-50 border-0 my-5 py-2 px-4 focus:outline-none hover:bg-pink-100 rounded-full text-sm">Try for Free →</button>
                    </div>
                  </Link>
                </div>
              </div>
