        ...
        <div className="container px-5 py-10 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <div className="flex justify-center">
              <h1 className="sm:text-3xl text-2xl text-bold font-medium title-font mt-8 text-purple-600">
          ...
          <div className="flex flex-wrap -m-8 text-center">
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="bg-purple-50 px-4 py-6 rounded-lg">
                <svg
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="bg-purple-50 px-4 py-6 rounded-lg">
                ...
                {/* <p className="leading-relaxed uppercase">Right</p> */}
                <h2 className="title-font text-xl text-gray-900 text-center">
