...
import ecommerce2Json from "../../../assets/animations/ecommerce2.json";

const features = {
    loop: true,
    autoplay: true,
    animationData: ecommerce2Json,
    // rendererSettings: {
          ...
          <div class="flex flex-wrap w-full">
            ...
            <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
              <div class="flex relative pb-12">
                ...
                <div class="flex-shrink-0 w-10 h-10 rounded-full bg-pink-500 inline-flex items-center justify-center text-white relative">
                  <svg
                    fill="none"
                    stroke="currentColor"
