      ...
      <section class="text-gray-600 bg-gray-50 body-font">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto">
            ...
            No Setup Fees – Automate Your Business with vajra.ai
            </h1>
            <Link href="https://api.whatsapp.com/send?phone=916302396226">
            <button class="flex-shrink-0 text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded-full text-lg mt-10 sm:mt-0">
              Let's Get Started
            </button>
            </Link>
          </div>
