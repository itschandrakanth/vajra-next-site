...
import contact from "../../assets/animations/users-profiles.json";
  ...
  return (
    <Box id="request" as="section" variant="section.features">
      <Container>
        ...
        Automate your Business today with World Class Customer Service in no time with our <span sx={styles.spanColor}>WhatsApp Business API </span>
        </Heading>
        <p className="text-2xl text-center p-2"></p>
            ...
            <div className="container px-5 py-24 mx-auto flex">
                ...
                <form onSubmit={handleOnSubmit}>
                  <div className="flex flex-wrap -m-2">
                              ...
                              <button  className="text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg">Let me in!</button>
                          </div>
...
const styles = {
  ...
  badaTitle: {
    fontWeight: 'bold',
    fontSize: ['28px', null, null, null, '48px', '48px', '34px'],
    lineHeight: 1.33,
    letterSpacing: '-1px',
    alignItems: 'center',
    textAlign: 'center',
